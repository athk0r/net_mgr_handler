// This code was autogenerated with `dbus-codegen-rust -s -g -m None -d org.freedesktop.NetworkManager -p /org/freedesktop/NetworkManager/ActiveConnection/5`, see https://github.com/diwic/dbus-rs
use dbus as dbus;
use dbus::arg;
use dbus::blocking;
...
impl<'a, C: ::std::ops::Deref<Target=blocking::Connection>> OrgFreedesktopNetworkManagerConnectionActive for blocking::Proxy<'a, C> {
...
impl arg::ReadAll for OrgFreedesktopNetworkManagerConnectionActivePropertiesChanged {
    fn read(i: &mut arg::Iter) -> Result<Self, arg::TypeMismatchError> {
        Ok(OrgFreedesktopNetworkManagerConnectionActivePropertiesChanged {
            properties: i.read()?,
        })
    }
}
